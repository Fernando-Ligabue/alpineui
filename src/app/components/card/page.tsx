    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl">
      {plans.map((plan) => (
        <button
          ...
          className={`rounded-lg border bg-white shadow-sm text-left ${
            selectedPlan === plan.id ? "ring-2 ring-black border-gray-200" : "border-gray-200"
          }`}
        >
          <div className="flex flex-col gap-1.5 p-6">
            {plan.id === "pro" && <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-md bg-black text-white w-fit">Popular</span>}
          ...
          <div className="p-6 pt-0">
            <div className="flex flex-col">
              <span className="text-2xl font-bold leading-tight text-gray-900">{plan.price}</span>
          ...
          <div className="flex items-center p-6 pt-0 *:flex-1">
            <button className={`inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 ${
              selectedPlan === plan.id ? "bg-black text-white hover:opacity-90" : "border border-gray-300 bg-transparent text-gray-900 hover:bg-gray-100"
            }`}>
        ...
        <DemoBlock
          preview={
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl">
              ...
              <div className="rounded-lg bg-gray-100 border border-transparent shadow-sm">
                <div className="flex flex-col gap-1.5 p-6">
...
<div class="rounded-lg border-2 border-gray-200 bg-white">
  ...
  <div class="p-6 pt-0">Solid border.</div>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">More Variants</h2>
        <DemoBlock
          preview={
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
              ...
              <div className="rounded-lg bg-white/80 backdrop-blur-sm border border-gray-200 shadow-sm">
                <h3 className="text-sm font-semibold leading-tight tracking-tight p-6 pb-0">Glass</h3>
                <div className="p-6 pt-3">Blur effect.</div>
              </div>
              <div className="rounded-lg border-2 border-dashed border-gray-200 bg-white">
          ...
          preview={
            <div className="flex flex-col gap-3 w-full max-w-sm">
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-3">
                <div className="text-sm text-gray-900">Small</div>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-4">
                <div className="text-sm text-gray-900">Medium</div>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6">
                <div className="text-sm text-gray-900">Large</div>
              </div>
            </div>
          }
        ...
        <DemoBlock
          preview={
            <div className="grid grid-cols-2 gap-4 w-full max-w-lg">
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-4 cursor-pointer transition-all hover:border-gray-300 hover:shadow-md active:scale-[0.98] select-none">
                <div className="text-sm text-gray-900">Hover here</div>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-4 animate-pulse relative overflow-hidden">
...
<div class="rounded-lg border border-gray-200 bg-white shadow-sm p-4 animate-pulse relative overflow-hidden">
  <div class="text-sm text-gray-900">Loading...</div>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Card with Footer</h2>
        <DemoBlock
          preview={
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm w-full max-w-md">
              <div className="flex flex-col gap-1.5 p-6">
              ...
              <div className="flex items-center justify-between p-6 pt-0">
                <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 border border-gray-300 bg-transparent text-gray-900 hover:bg-gray-100">Cancel</button>
  ...
  <div class="flex items-center justify-between p-6 pt-0">
    ...
    <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 bg-black text-white hover:opacity-90">Confirm</button>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Card Stats</h2>
        <DemoBlock
          preview={
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm w-full max-w-lg">
              <div className="flex flex-col gap-1.5 p-6">
              ...
              <div className="p-6 pt-0 flex gap-12 justify-center text-center">
                <div className="flex flex-col">
                  <span className="text-2xl font-bold leading-tight text-gray-900">10.5K</span>
                  <span className="text-sm text-gray-500">Visitors</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-2xl font-bold leading-tight text-gray-900">893</span>
                  <span className="text-sm text-gray-500">Sales</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-2xl font-bold leading-tight text-gray-900">12%</span>
  ...
  <div class="p-6 pt-0 flex gap-12 justify-center text-center">
    ...
    <div class="flex flex-col">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Card with Image</h2>
        <DemoBlock
          preview={
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm w-full max-w-sm">
              <Image
              ...
              <div className="flex flex-col gap-1.5 p-6 space-y-1">
                ...
                <p className="text-sm text-gray-500">Abstract art in shades of blue.</p>
              </div>
              ...
              <div className="flex items-center justify-between p-6 pt-0">
                ...
                <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 bg-black text-white hover:opacity-90">See more</button>
              </div>
            </div>
          }
          code={`<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
  ...
  <div class="flex items-center justify-between p-6 pt-0">
    <span class="flex items-center gap-2 text-xs text-gray-500">Meta info</span>
    <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 bg-black text-white hover:opacity-90">Action</button>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Card with Avatar</h2>
        <DemoBlock
          preview={
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm w-full max-w-sm">
              <div className="flex flex-col gap-1.5 p-6">
              ...
              <div className="flex items-center justify-between p-6 pt-0">
                <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 border border-gray-300 bg-transparent text-gray-900 hover:bg-gray-100">Cancel</button>
                <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 bg-black text-white hover:opacity-90">Invite</button>
              </div>
            </div>
          }
          code={`<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
  ...
  <div class="flex items-center justify-between p-6 pt-0">
    ...
    <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 bg-black text-white hover:opacity-90">Confirm</button>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Card with List</h2>
        <DemoBlock
          preview={
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm w-full max-w-sm">
              <div className="flex flex-col gap-1.5 p-6">
                <h3 className="text-lg font-semibold leading-tight tracking-tight">Tasks</h3>
                <p className="text-sm text-gray-500">2 of 5 completed</p>
              </div>
              <div className="p-6 pt-0">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3 py-2 border-b border-gray-200 last:border-b-0">
                    <input type="checkbox" checked className="h-4 w-4 rounded border-gray-300" />
                    <span className="line-through text-gray-500">Create tests</span>
                  </div>
                  <div className="flex items-center gap-3 py-2 border-b border-gray-200 last:border-b-0">
  ...
  <div class="p-6 pt-0">
    <div class="flex flex-col gap-2">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Card Interactive</h2>
        <DemoBlock
          preview={
            <div className="grid grid-cols-2 gap-4 w-full max-w-lg">
              <button className="rounded-lg border border-gray-200 bg-white shadow-sm text-left cursor-pointer transition-all select-none hover:border-gray-300 hover:shadow-md active:scale-[0.98]">
                <div className="flex flex-col gap-1.5 p-6">
              ...
              <button className="rounded-lg border border-gray-200 bg-white shadow-sm text-left cursor-pointer transition-all select-none hover:border-gray-300 hover:shadow-md active:scale-[0.98] ring-2 ring-black">
                <div className="flex flex-col gap-1.5 p-6">
...
<button class="rounded-lg border border-gray-200 bg-white shadow-sm text-left cursor-pointer transition-all select-none hover:border-gray-300 hover:shadow-md active:scale-[0.98] ring-2 ring-black">
  <div class="flex flex-col gap-1.5 p-6">
    ...
    <p class="text-sm text-gray-500">Selected state</p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Pricing Card</h2>
        <DemoBlock
          preview={
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl">
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
                ...
                <div className="p-6 pt-0">
                  <div className="flex flex-col">
                    <span className="text-2xl font-bold leading-tight text-gray-900">€ 0</span>
                    <span className="text-sm text-gray-500">/mounth</span>
                  </div>
                  <ul className="mt-4 space-y-2 text-sm">
              ...
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm ring-2 ring-black">
                <div className="flex flex-col gap-1.5 p-6">
                  <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-md bg-black text-white w-fit">Popular</span>
                  <h3 className="text-lg font-semibold leading-tight tracking-tight mt-2">Pro</h3>
                  <p className="text-sm text-gray-500">For teams</p>
                </div>
                <div className="p-6 pt-0">
                  <div className="flex flex-col">
                    <span className="text-2xl font-bold leading-tight text-gray-900">€ 49</span>
                    <span className="text-sm text-gray-500">/mounth</span>
                  </div>
                  <ul className="mt-4 space-y-2 text-sm">
                ...
                <div className="flex items-center p-6 pt-0 *:flex-1">
                  <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 bg-black text-white hover:opacity-90">Sign in</button>
                </div>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
                <div className="flex flex-col gap-1.5 p-6">
                  <h3 className="text-lg font-semibold leading-tight tracking-tight">Enterprise</h3>
                  <p className="text-sm text-gray-500">For big teams</p>
                </div>
                <div className="p-6 pt-0">
                  <div className="flex flex-col">
                    <span className="text-2xl font-bold leading-tight text-gray-900">Custom</span>
                  </div>
                  <ul className="mt-4 space-y-2 text-sm">
                ...
                <div className="flex items-center p-6 pt-0 *:flex-1">
                  <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 disabled:pointer-events-none h-8 px-3 border border-gray-300 bg-transparent text-gray-900 hover:bg-gray-100">Contact us</button>
                </div>
              </div>
            </div>
          }
