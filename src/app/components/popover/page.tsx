  ...
  return (
    <div className="flex flex-wrap gap-6 justify-center py-4">
      <div className="inline-flex items-center group relative">
        ...
        <div className="absolute z-50 w-72 rounded-md border border-gray-200 bg-white p-4 shadow-md invisible group-hover:visible top-full left-1/2 -translate-x-1/2 mt-2">
      ...
      <div className="inline-flex items-center group relative">
        ...
        <div className="absolute z-50 w-72 rounded-md border border-gray-200 bg-white p-4 shadow-md invisible group-hover:visible left-full top-1/2 -translate-y-1/2 ml-2">
...
export default function PopoverPage() {
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Popover</h1>
