    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="fixed left-[50%] top-[50%] z-50 translate-x-[-50%] translate-y-[-50%] w-full max-w-lg bg-white rounded-lg shadow-lg border border-gray-200 p-6">
...
export default function DialogPage() {
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Dialog</h1>
      <p className="text-gray-500 mb-8">
        A modal dialog component for focused interactions and confirmations.
      </p>

      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Basic Dialog</h2>
        <DemoBlock
          preview={
        ...
        <DemoBlock
          preview={
            <div className="flex flex-wrap gap-4 items-start justify-center py-4">
              <div className="w-full max-w-xs bg-white rounded-lg shadow-lg border border-gray-200 p-4 text-center">
                <span className="text-sm">Small</span>
              </div>
              <div className="w-full max-w-md bg-white rounded-lg shadow-lg border border-gray-200 p-4 text-center">
                <span className="text-sm">Medium</span>
              </div>
              <div className="w-full max-w-xl bg-white rounded-lg shadow-lg border border-gray-200 p-4 text-center">
...
<div class="w-full max-w-xl bg-white rounded-lg shadow-lg border border-gray-200 p-4 text-center">Large</div>`}
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Alert Dialog</h2>
        <DemoBlock
          preview={
            <InteractiveDialog 
              title="Delete Item" 
...
<div class="fixed left-[50%] top-[50%] z-50 translate-x-[-50%] translate-y-[-50%] w-full max-w-sm bg-white rounded-lg shadow-lg border border-gray-200 p-6">
  ...
  <div class="flex flex-col-reverse sm:flex-row justify-end gap-2 mt-6">
    <button class="px-3 py-1.5 bg-black text-white text-sm font-medium rounded-md">Delete</button>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Form Dialog</h2>
        <DemoBlock
          preview={
            <InteractiveDialog title="Edit Profile" showFooter={true}>
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" defaultValue="John Smith" />
                </div>
                <div>
