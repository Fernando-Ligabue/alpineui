...
export default function DialogPage() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-au-foreground mb-2">{t("dialog.title")}</h1>
      <p className="text-au-muted-foreground mb-8">
        {t("dialog.description")}
      </p>

      <section className="mb-8">
        <h2 className="text-xl font-semibold text-au-foreground mb-4">{t("common.basicDialog")}</h2>
        <DemoBlock
          preview={
            <InteractiveDialog title={t("common.confirmAction")} description={t("common.areYouSure")}>
              <p>{t("common.basicDialogExample")}</p>
            </InteractiveDialog>
          }
...
<div class="w-full max-w-xl bg-white rounded-lg shadow-lg border border-gray-200 p-4 text-center">Large</div>`}
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-au-foreground mb-4">{t("common.alertDialog")}</h2>
        <DemoBlock
          preview={
            <InteractiveDialog 
...
<div class="fixed left-[50%] top-[50%] z-50 translate-x-[-50%] translate-y-[-50%] w-full max-w-sm bg-white rounded-lg shadow-lg border border-gray-200 p-6">
  ...
  <div class="flex flex-col-reverse sm:flex-row justify-end gap-2 mt-6">
    <button class="px-3 py-1.5 bg-black text-white text-sm font-medium rounded-md">Delete</button>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-au-foreground mb-4">{t("common.formDialog")}</h2>
        <DemoBlock
          preview={
            <InteractiveDialog title={t("common.editProfile")} showFooter={true}>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-au-foreground mb-1">{t("common.nameLabel")}</label>
