...
export default function SpinnerPage() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-au-foreground mb-2">{t("spinner.title")}</h1>
      <p className="text-au-muted-foreground mb-8">{t("spinner.description")}</p>
...
<svg class="animate-spin w-12 h-12 text-gray-900" fill="none" viewBox="0 0 24 24">...</svg>`}
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-au-foreground mb-4">{t("common.colors")}</h2>
        <DemoBlock
          preview={
        ...
        <DemoBlock
          preview={
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-au-muted-foreground">{t("common.loading")}</span>
            </div>
          }
