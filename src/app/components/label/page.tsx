...
export default function LabelPage() {
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-au-foreground mb-2">Label</h1>
      <p className="text-au-muted-foreground mb-8">A form label component with optional required indicator.</p>
        ...
        <DemoBlock
          preview={
            <div className="space-y-6 w-full max-w-md">
              <div>
                <label className="block text-sm font-medium text-au-foreground mb-1.5">Email</label>
...
<div>
  ...
  <input type="password" class="flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm" />
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-au-foreground mb-4">With Description</h2>
        <DemoBlock
          preview={
            <div className="w-full max-w-md space-y-6">
              <div>
                <label className="block text-sm font-medium text-au-foreground mb-1">Full Name</label>
                <p className="text-xs text-au-muted-foreground mb-2">This will be displayed on your profile.</p>
              ...
              <div>
                <label className="block text-sm font-medium text-au-foreground mb-1">Bio</label>
                <p className="text-xs text-au-muted-foreground mb-2">Tell us a little about yourself.</p>
  ...
  <input type="text" class="flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm" />
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-au-foreground mb-4">With Checkbox</h2>
        <DemoBlock
          preview={
            <div className="space-y-3 w-full max-w-md">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm font-medium text-au-foreground">Accept terms and conditions</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="peer sr-only" />
                <div className="h-4 w-4 rounded border border-au-border peer-checked:bg-au-primary peer-checked:border-au-primary flex items-center justify-center after:content-[''] after:block after:w-1.5 after:h-1.5 after:rotate-45 after:border-r-2 after:border-b-2 after:border-au-background after:mt-[-1px] after:invisible peer-checked:after:visible shrink-0" />
                <span className="text-sm font-medium text-au-foreground">Subscribe to newsletter</span>
              </label>
            </div>
          }
