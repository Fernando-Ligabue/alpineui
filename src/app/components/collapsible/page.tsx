  ...
  return (
    <div className="w-full max-w-md border border-gray-200 rounded-lg overflow-hidden">
      <button
        ...
        className="flex w-full items-center justify-between px-4 py-3 text-sm font-medium text-left text-gray-900 hover:bg-gray-50 transition-colors"
      >
        <span>Show details</span>
        <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${open ? "rotate-180" : ""}`} />
      </button>
      {open && (
        <div className="px-4 pb-4 text-sm text-gray-500 border-t border-gray-200 pt-3">
...
export default function CollapsiblePage() {
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Collapsible</h1>
      <p className="text-gray-500 mb-8">An expandable content container for showing and hiding sections.</p>
