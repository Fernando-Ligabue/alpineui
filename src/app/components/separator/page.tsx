...
export default function SeparatorPage() {
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Separator</h1>
      <p className="text-gray-500 mb-8">A horizontal or vertical divider to separate content sections.</p>

      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Horizontal</h2>
        <DemoBlock
          preview={
            <div className="w-full max-w-md space-y-4">
              <div className="text-sm text-gray-700">Content above</div>
              <hr className="border-t border-gray-200" />
              <div className="text-sm text-gray-700">Content below</div>
            </div>
          }
          ...
          preview={
            <div className="w-full max-w-md">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-gray-500 shrink-0">Or continue with</span>
                <hr className="flex-1 border-t border-gray-200" />
              </div>
            </div>
          }
  ...
  <span class="text-xs text-gray-500 shrink-0">Or continue with</span>
  <hr class="flex-1 border-t border-gray-200" />
</div>`}
        />
      </section>
        ...
        <DemoBlock
          preview={
            <div className="space-y-6 w-full max-w-md">
              <div>
                <p className="text-xs text-gray-500 mb-2">Light</p>
                <hr className="border-t border-gray-200" />
              </div>
              <div>
              ...
              <div>
                <p className="text-xs text-gray-500 mb-2">Bold</p>
