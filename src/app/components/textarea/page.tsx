        ...
        <DemoBlock
          preview={
            <div className="space-y-4 w-full max-w-md">
              <textarea className="flex min-h-[80px] w-full rounded-md border border-au-border bg-au-background px-3 py-2 text-sm placeholder:text-au-muted-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-au-ring disabled:cursor-not-allowed disabled:opacity-50" placeholder="Default" />
              ...
              <textarea className="flex min-h-[80px] w-full rounded-md border border-red-500 bg-au-background px-3 py-2 text-sm placeholder:text-au-muted-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500 disabled:cursor-not-allowed disabled:opacity-50" placeholder="Error state" />
              <textarea className="flex min-h-[80px] w-full rounded-md border border-au-border bg-au-secondary px-3 py-2 text-sm placeholder:text-au-muted-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-au-ring disabled:cursor-not-allowed disabled:opacity-50" placeholder="Disabled" disabled />
            </div>
          }
